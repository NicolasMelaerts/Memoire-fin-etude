...
def plot_curves(histories, epochs, output_path):
    ...
    fig.suptitle('CUB-200 : SimpleCNN & ResNet18 · Normal vs GradCAM-Guided', fontsize=13, fontweight='bold')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CUB-200 : SimpleCNN & ResNet18 · Normal vs GradCAM-Guided')
    ...
    print('=' * 70)
    print('  CUB-200-2011 : SimpleCNN & ResNet18 · Normal vs GradCAM-Guided')
    print('=' * 70)
    ...
    configs = [
        ...
        ('Normal-ResNet18',      'normal',  ResNet18_CUB),
        ('GradCAM-ResNet18',     'gradcam', ResNet18_CUB),
    ]
