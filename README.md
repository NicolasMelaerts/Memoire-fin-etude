...
*   **Installation :**
    ...
    └── oiseaux/
        ...
        ├── cvpr2016_cub/      # Contient les métadonnées et splits
        └── segmentations/     # Contient les masques d'oiseaux (.png)
    ```
...
*   **Installation :**
    ...
    real_datasets/
    └── poissons/
        └── fish-dataset/      # Contient Gilt-Head Bream/, Gilt-Head Bream GT/, etc. (renommé depuis "Fish_Dataset")
    ```
